...
class SearchHeaderView: UIView {
    ...
    private func setupBtns() {
        ...
        for i in 0 ..< btnTitles.count {
            ...
            let width:CGFloat = titleStr.boundingRect(with: CGSize.zero, options: NSStringDrawingOptions(rawValue: 0), attributes: [NSAttributedStringKey.font : tagBtn.titleLabel!.font], context: nil).width + 20 * 2
            
            tagBtn.tag = i
            tagBtn.setTitle(titleStr as String, for: UIControlState.normal)
    ...
    private func createBtn() -> UIButton {
        ...
        tagBtn.setTitleColor(UIColor(red: 80.0/255.0, green: 80.0/255.0, blue: 80.0/255.0, alpha: 1.0), for: UIControlState.normal)
        return tagBtn
    }
    ...
    @objc private func tagBtnAction() {
        NotificationCenter.default.post(name: NSNotification.Name(rawValue: "Notif_BtnAction_SearchTag"), object: nil)
    }
