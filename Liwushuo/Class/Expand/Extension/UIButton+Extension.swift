...
extension UIButton {
    ...
    convenience init(srotTagTarget: AnyObject?, action: Selector) {
        self.init()
        setBackgroundImage(UIImage.imageWithColor(color: UIColor.white, size: CGSize(width: 1, height: 1)), for: UIControlState.normal)
        setBackgroundImage(UIImage.imageWithColor(color: UIColor(red: 251.0/255.0, green: 45.0/255.0, blue: 71.0/255.0, alpha: 1.0), size: CGSize(width: 1, height: 1)), for: UIControlState.selected)
        setBackgroundImage(UIImage.imageWithColor(color: UIColor.red, size: CGSize(width: 1, height: 1)), for: UIControlState.highlighted)
